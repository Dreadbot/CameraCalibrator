...
cams = {                                                                              # METERS-----------------------       RAD---------
    ...
    cv2.VideoCapture(-1): {"Parameters": get_parameters("front_camera.yaml"), "Pose": ["X OFFSET", "Y OFFSET", "Z OFFSET", "YAW", "PITCH"]},
    #cv2.VideoCapture(-1): {"Parameters": get_parameters("back_camera.yaml"),  "Pose": ["X OFFSET", "Y OFFSET", "Z OFFSET", "YAW", "PITCH"]}
}
    ...
    while True:
        ...
        for cam in cams: 
            ...
            for tag in tags:
                ...
                offset = calculate_tag_offset(tag.pose_t, cams[cam]["Pose"])
